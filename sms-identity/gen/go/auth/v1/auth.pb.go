...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\x0eportal.auth.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bbuf/validate/validate.proto\"b\n" +
	"\fLoginRequest\x12*\n" +
	"\n" +
	...
	"\n" +
	"expires_in\x18\x04 \x01(\x03R\texpiresIn\"\x95\x01\n" +
	"\rLoginResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\x12\x1d\n" +
	"\n" +
	"token_type\x18\x03 \x01(\tR\ttokenType\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x04 \x01(\x03R\texpiresIn2\xc3\x03\n" +
	"\vAuthService\x12c\n" +
	...
	"\fRefreshToken\x12\x1e.portal.auth.v1.RefreshRequest\x1a\x1f.portal.auth.v1.RefreshResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/api/v1/auth/refresh\x12g\n" +
	"\x06Logout\x12\x1d.portal.auth.v1.LogoutRequest\x1a\x1e.portal.auth.v1.LogoutResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/api/v1/auth/logout\x12t\n" +
	"\tLogoutAll\x12 .portal.auth.v1.LogoutAllRequest\x1a!.portal.auth.v1.LogoutAllResponse\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/api/v1/auth/logout-allB%Z#portal-system/gen/go/auth/v1;authv1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	(*LoginRequest)(nil),      // 0: portal.auth.v1.LoginRequest
	(*RefreshRequest)(nil),    // 1: portal.auth.v1.RefreshRequest
	(*LogoutRequest)(nil),     // 2: portal.auth.v1.LogoutRequest
	(*LogoutResponse)(nil),    // 3: portal.auth.v1.LogoutResponse
	(*LogoutAllRequest)(nil),  // 4: portal.auth.v1.LogoutAllRequest
	(*LogoutAllResponse)(nil), // 5: portal.auth.v1.LogoutAllResponse
	(*RefreshResponse)(nil),   // 6: portal.auth.v1.RefreshResponse
	(*LoginResponse)(nil),     // 7: portal.auth.v1.LoginResponse
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	0, // 0: portal.auth.v1.AuthService.Login:input_type -> portal.auth.v1.LoginRequest
	1, // 1: portal.auth.v1.AuthService.RefreshToken:input_type -> portal.auth.v1.RefreshRequest
	2, // 2: portal.auth.v1.AuthService.Logout:input_type -> portal.auth.v1.LogoutRequest
	4, // 3: portal.auth.v1.AuthService.LogoutAll:input_type -> portal.auth.v1.LogoutAllRequest
	7, // 4: portal.auth.v1.AuthService.Login:output_type -> portal.auth.v1.LoginResponse
	6, // 5: portal.auth.v1.AuthService.RefreshToken:output_type -> portal.auth.v1.RefreshResponse
	3, // 6: portal.auth.v1.AuthService.Logout:output_type -> portal.auth.v1.LogoutResponse
	5, // 7: portal.auth.v1.AuthService.LogoutAll:output_type -> portal.auth.v1.LogoutAllResponse
