...
// Publish provides a mock function with given fields: ctx, stream, values
func (_m *MockPublisher) Publish(ctx context.Context, stream string, values []interface{}) error {
...
//   - stream string
//   - values []interface{}
func (_e *MockPublisher_Expecter) Publish(ctx interface{}, stream interface{}, values interface{}) *MockPublisher_Publish_Call {
	return &MockPublisher_Publish_Call{Call: _e.mock.On("Publish", ctx, stream, values)}
}

func (_c *MockPublisher_Publish_Call) Run(run func(ctx context.Context, stream string, values []interface{})) *MockPublisher_Publish_Call {
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(context.Context, string, []interface{}) error) *MockPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
