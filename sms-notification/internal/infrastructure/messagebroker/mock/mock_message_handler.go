...
func (_m *MockMessageHandler) Execute(ctx context.Context, msg messagebroker.Message) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, messagebroker.Message) error); ok {
		r0 = rf(ctx, msg)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockMessageHandler_Execute_Call) Run(run func(ctx context.Context, msg messagebroker.Message)) *MockMessageHandler_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(messagebroker.Message))
	})
	return _c
}
...
func (_c *MockMessageHandler_Execute_Call) RunAndReturn(run func(context.Context, messagebroker.Message) error) *MockMessageHandler_Execute_Call {
	_c.Call.Return(run)
	return _c
}
